...
void failoSkaitymas(deque<studentas> &grupe);
void failoIrasymas(deque<studentas> &grupe, int partPoint);
int partitionIrSort(deque<studentas> &grupe, bool rusiavimasChoice);
void pazPalyginimas(deque<studentas> &grupe, bool rusiavimoPas);
...
void naudotojoIvestis(deque<studentas> &grupe);
...
int partitionIrSort(deque<studentas> &grupe, bool rusiavimasChoice) {
    ...
    if (rusiavimasChoice) {
        sort(grupe.begin(), grupe.end(), [](const studentas& a, const studentas &b){ return a.galutinisVid < b.galutinisVid; });
    }
    else {
        sort(grupe.begin(), grupe.end(), [](const studentas& a, const studentas &b){ return a.galutinisMed < b.galutinisMed; });
    }
