...
void failoIrasymas(vector<studentas> &saunuoliai, vector<studentas> &vargsai);
void splitIrSort(vector<studentas> &grupe, vector<studentas> &saunuoliai, vector<studentas> &vargsai, bool rusiavimasChoice);
...
int main() {
    ...
    if (skaitymas) {
        ...
        failoIrasymas(saunuoliai, vargsai);
    }
    else {
...
void splitIrSort(vector<studentas> &grupe, vector<studentas> &saunuoliai, 
vector<studentas> &vargsai, bool rusiavimasChoice) {
